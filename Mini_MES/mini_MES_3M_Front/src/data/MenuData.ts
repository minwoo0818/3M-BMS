export const menuItems = [
  ...
  },
  {
    ...
    items: [
      { 
        ...
        items: [
          { name: '원자재품목 입고 등록', path: '/material/inbound/register' },
          { name: '원자재품목 입고 이력조회', path: '/material/inbound/history' },
      ...
      },
      {
        name: '원자재품목 출고',
        items:[
            { name: '원자재품목 출고 등록', path: '/material/outbound/register' },
            { name: '원자재품목 출고 이력조회', path: '/material/outbound/history' },
        ]
      },
      { 
      ...
      { 
        name: '품목관리', // 2 depth
        items: [
          { name: '원자재품목 등록', path: '/material/item/register' },
          { name: '원자재품목 조회', path: '/material/item/history' },
        ]
      },
    ],
  },
  {
    ...
    items: [
      ...
      { name: '거래처',
        items: [
            { name: '거래처 등록', path: '/info/customer/register' },
            { name: '거래처 관리', path: '/info/customer/management' },
        ] },
    ],
  },
];