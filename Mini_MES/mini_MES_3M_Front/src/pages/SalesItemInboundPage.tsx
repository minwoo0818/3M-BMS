...
// ⭐ 1. useNavigate 훅을 사용하기 위해 react-router-dom에서 import
...
const SalesItemInboundPage: React.FC = () => {
 ...
 // ⭐ 3. 품목명 클릭 핸들러 추가
 const handleItemNameClick = useCallback((salesItemId: number) => {
  // 수주품목 상세 조회 페이지 경로로 이동
       ...
       {currentItems.map((item) => (
        ...
        >
         ...
         <td 
          ...
          onClick={() => handleItemNameClick(item.salesItemId)}
         >
          {item.itemName}
         </td>
