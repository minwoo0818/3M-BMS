// src/main/java/com/mini_mes_3m_back/dto/RawsItem/RawsItemUpdateRequestDto.java (새로 생성!)
...
@NoArgsConstructor
@AllArgsConstructor
public class RawsItemUpdateRequestDto {
    // private Long rawsItemId; // PathVariable로 받으므로 요청 바디에는 포함하지 않음
