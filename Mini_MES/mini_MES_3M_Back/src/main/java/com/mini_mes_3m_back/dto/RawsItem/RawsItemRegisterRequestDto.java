// src/main/java/com/mini_mes_3m_back/dto/RawsItem/RawsItemRegisterRequestDto.java (새로 생성!)
...
@NoArgsConstructor
@AllArgsConstructor
public class RawsItemRegisterRequestDto {
    ...
    private String classification; // 페인트, 신나 등
